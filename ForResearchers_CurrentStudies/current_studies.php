  ...
  <body>
    <div class = "page-content">
      ...
      <div class="page-body">
        ...
        <h1>Current Cardiology Projects</h1>
        <ul>
          <li>Development and Evaluation of Novel PET-MR Acquisition and Reconstruction Techniques for Improved Diagnosis of Heart Disease</li>
        </ul>
        ...
        <ul>
          ...
          <li>Dopamine release and blood flow changes during induced epileptic seizures assessed with simultaneous PET-MR</li>
          <li>The role of inflammation in brain and cognitive function in mental disorders (IRIS)</li>
          <li>Evaluation of Brain PET/MR versus PET-CT</li>
        </ul>
        ...
        <ul>
          ...
          <li>A Phase 2b Open-label, Randomized Two-arm Study of Selinexor (KPT-330) with Low Dose Dexamethasone in Patients with Relapsed/Refractory Diffuse Large B-Cell Lymphoma (DLBCL) - SADAL</li>
