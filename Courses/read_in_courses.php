    ...
    <div class="LR-container">
      ...
      <div class="LI-text">
        ...
        <?php if ($course[13] == "1") {
          ...
          $datePhrase = "from the " . date_format($course_date, 'jS F Y') . " to the " . date_format(date_add($course_date, date_interval_create_from_date_string($course[13] . " days")), 'jS F Y');
        } ?>
