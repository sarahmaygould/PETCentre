    ...
    <div class = "page-content">
      ...
      <div class="page-body">
        ...
        <div class="LR-container">
          <div class="LI-image">
            <img src="images/LondonEye_small.jpg" alt="MSc Radiopharmaceuticals Course" width="150">
          </div>
          <div class="LI-text">
            <h1>MSc and MRes in PET Radiochemistry</h1>
            <p>
            ...
            <p>
              <a href="http://www.kcl.ac.uk/study/postgraduate/taught-courses/radiopharmaceutics-and-pet-radiochemistry-msc-pg-dip-pg-cert.aspx" target="_blank">Click here for more information and to apply.</a>
            </p>
          </div>
        </div>
        ...
        <div class="LR-container">
          <div class="LI-image">
            <img src="images/PETCT_small.png" alt="MSc Nuclear Medicine Course" width="150">
          </div>
          <div class="LI-text">
            <h1>MSc in Nuclear Medicine</h1>
            <p>
