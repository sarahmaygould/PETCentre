    ...
    <div class = "page-content">
      ...
      <div class="page-body">
        <div class="page-title">
          PET-MR Scanning: Frequently Asked Questions
        </div>

        <h1>What is a PET-MR scan?</h1>
        <p>
        ...
        <h1>What are the benefits of a PET scan?</h1>
        <p>
        ...
        <h1>What are the benefits of an MRI scan?</h1>
        <p>
        ...
        <p>
          <b>You will be asked to complete and sign a safety questionnaire before your scan to make sure it is safe for you to be scanned.</b>
        </p>

        <hr>

        <h1>Is it safe for me to have a PET-MR if I am pregnant?</h1>
        <p>
        ...
        <h1>Are there any alternatives?</h1>
        <p>
        ...
        <h1>Giving your consent (permission)</h1>
        <p>
        ...
        <h1>What do I have to do to prepare for the scan?</h1>
        <p>
        ...
        <h1>Will I need an injection?</h1>
        <p>
        ...
        <p>If we are scanning your head, you will need to remove dentures which contain metal. Dental fillings will not affect the scan. Hairclips and wigs must also be removed if they contain metal.
        </p>

        <hr>

        <h1>What happens during the scan?</h1>
        <p>
        ...
        <h1>Will there be anyone with me during the scan?</h1>
        <p>
